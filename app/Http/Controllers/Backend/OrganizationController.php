...
class OrganizationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'user_id.required' => 'Ишлаб-чикариш филиалинига жавобгарни ходимни танланг.',
            'title.required' => 'Ишлаб-чикариш филиали номи мажбурий.',
            'title.string'   => 'Ишлаб-чикариш филиали номи матн бўлиши керак.',
        ]);

        Organization::create($request->all());

        return redirect()->route('organization.index')->with('success', 'Ишлаб-чикариш филиали яратилди!');
    }
